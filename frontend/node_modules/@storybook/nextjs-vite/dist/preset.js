import CJS_COMPAT_NODE_URL_por6qaed7 from 'node:url';
import CJS_COMPAT_NODE_PATH_por6qaed7 from 'node:path';
import CJS_COMPAT_NODE_MODULE_por6qaed7 from "node:module";

var __filename = CJS_COMPAT_NODE_URL_por6qaed7.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_por6qaed7.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_por6qaed7.createRequire(import.meta.url);
...
import {
  ...
  __require,
  __toESM
} from "./_node-chunks/chunk-LOLOCQUS.js";
...
var require_req = __commonJS({
  "../../../node_modules/postcss-load-config/src/req.js"(exports, module) {
    ...
    async function req(name, rootFile = __filename) {
      ...
      if (jiti === void 0)
        try {
          jiti = (await import("./_node-chunks/jiti-HRCX47I2.js")).default;
        } catch (error) {
          importError.push(error);
        }
      if (jiti)
...
var require_src2 = __commonJS({
  "../../../node_modules/postcss-load-config/src/index.js"(exports, module) {
    ...
    async function yamlLoader(_, content) {
      if (!yaml)
        try {
          yaml = await import("./_node-chunks/dist-ZWX7TAXB.js");
        } catch (e) {
          throw new Error(
