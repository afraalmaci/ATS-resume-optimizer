import CJS_COMPAT_NODE_URL_z3xabmh0por from 'node:url';
import CJS_COMPAT_NODE_PATH_z3xabmh0por from 'node:path';
import CJS_COMPAT_NODE_MODULE_z3xabmh0por from "node:module";

var __filename = CJS_COMPAT_NODE_URL_z3xabmh0por.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_z3xabmh0por.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_z3xabmh0por.createRequire(import.meta.url);
...
import {
  any
} from "./_node-chunks/chunk-L33NZLYB.js";
import {
  DOCUMENTATION_LINK
} from "./_node-chunks/chunk-ODGH25A4.js";
import {
  require_dist
} from "./_node-chunks/chunk-EYBUCBRO.js";
import {
  dirname,
  normalize,
  relative,
  resolve
} from "./_node-chunks/chunk-2LUX4PR6.js";
import {
  require_compare,
  require_constants,
  require_debug,
  ...
  require_re,
  require_semver
} from "./_node-chunks/chunk-S6IU7BZZ.js";
import {
  __commonJS,
  __toESM
} from "./_node-chunks/chunk-WPMTAB4K.js";
...
async function getTemplatePath(name) {
  switch (name) {
    case "vitest.config.template":
      return import("./_node-chunks/vitest.config-UM52QNAV.js");
    case "vitest.config.4.template":
      return import("./_node-chunks/vitest.config.4-CSW2NQUN.js");
    case "vitest.config.3.2.template":
      return import("./_node-chunks/vitest.config.3.2-6M7B7SFJ.js");
    case "vitest.workspace.template":
      return import("./_node-chunks/vitest.workspace-RGXJ4WW7.js");
    default:
