import CJS_COMPAT_NODE_URL_jde99xfi3po from 'node:url';
import CJS_COMPAT_NODE_PATH_jde99xfi3po from 'node:path';
import CJS_COMPAT_NODE_MODULE_jde99xfi3po from "node:module";

var __filename = CJS_COMPAT_NODE_URL_jde99xfi3po.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_jde99xfi3po.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_jde99xfi3po.createRequire(import.meta.url);

// ------------------------------------------------------------
// end of CJS compatibility banner, injected by Storybook's esbuild configuration
// ------------------------------------------------------------
import "./_node-chunks/chunk-GAEPR36A.js";
...
async function webpack(webpackConfig = {}, options) {
  let { module = {} } = webpackConfig, { csfPluginOptions = {}, mdxPluginOptions = {} } = options, enrichCsf = await options.presets.apply("experimental_enrichCsf"), rehypeSlug = (await import("./_node-chunks/rehype-slug-NERL3ZEL.js")).default, rehypeExternalLinks = (await import("./_node-chunks/rehype-external-links-OG3L7NZK.js")).default, mdxLoaderOptions = await options.presets.apply("mdxLoaderOptions", {
    ...mdxPluginOptions,
    mdxCompileOptions: {
...
var docs = (input = {}, options) => {
  ...
  let { plugins = [] } = config, { mdxPlugin } = await import("./_node-chunks/mdx-plugin-TYLLMKFC.js"), { react, reactDom, mdx } = await getResolvedReact(options), packageDeduplicationPlugin = {
