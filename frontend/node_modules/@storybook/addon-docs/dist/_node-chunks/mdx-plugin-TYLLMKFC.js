...
import {
  compile
} from "./chunk-6YWGSPSW.js";
import "./chunk-I7RZTHKT.js";
import "./chunk-AETO3UMO.js";
import {
  __commonJS,
  __toESM
} from "./chunk-GAEPR36A.js";
...
async function mdxPlugin(options) {
  let filter = createFilter(/\.mdx$/), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-NERL3ZEL.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-OG3L7NZK.js")).default;
  return {
