import CJS_COMPAT_NODE_URL_6l5p3p751x from 'node:url';
import CJS_COMPAT_NODE_PATH_6l5p3p751x from 'node:path';
import CJS_COMPAT_NODE_MODULE_6l5p3p751x from "node:module";

var __filename = CJS_COMPAT_NODE_URL_6l5p3p751x.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_6l5p3p751x.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_6l5p3p751x.createRequire(import.meta.url);
