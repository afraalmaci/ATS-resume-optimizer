import CJS_COMPAT_NODE_URL_j2v2vfprfie from 'node:url';
import CJS_COMPAT_NODE_PATH_j2v2vfprfie from 'node:path';
import CJS_COMPAT_NODE_MODULE_j2v2vfprfie from "node:module";

var __filename = CJS_COMPAT_NODE_URL_j2v2vfprfie.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_j2v2vfprfie.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_j2v2vfprfie.createRequire(import.meta.url);
...
import {
  toEstree
} from "../_node-chunks/chunk-W7PLKWYF.js";
import {
  StatusTypeIdMismatchError
} from "../_node-chunks/chunk-N3DDGOXK.js";
import {
  debounce,
  generateStoryFile,
  getErrorLevel,
  ...
  useStatics,
  withTelemetry
} from "../_node-chunks/chunk-JGB33OAY.js";
import {
  detectPnp
} from "../_node-chunks/chunk-H6E75LEJ.js";
import "../_node-chunks/chunk-PSTBZ6HM.js";
import {
  StorybookError
} from "../_node-chunks/chunk-CAMLDN46.js";
import {
  telemetry
} from "../_node-chunks/chunk-ABITR5BG.js";
import "../_node-chunks/chunk-EB5GIUP3.js";
import {
...
} from "../_node-chunks/chunk-4EBJDLX5.js";
import "../_node-chunks/chunk-BXLXD25W.js";
import "../_node-chunks/chunk-SK3PHBZ7.js";
import {
  require_pretty_hrtime
} from "../_node-chunks/chunk-43J6QFWG.js";
import "../_node-chunks/chunk-3ZHJHLRI.js";
import "../_node-chunks/chunk-3PGIQ7GX.js";
import {
  invariant,
  up2 as up
} from "../_node-chunks/chunk-UXL3FSTA.js";
import "../_node-chunks/chunk-3SJ6G6WO.js";
import {
  importModule,
  resolvePackageDir
} from "../_node-chunks/chunk-IMRCCHKI.js";
import {
  dirname,
  join,
  relative,
  resolve
} from "../_node-chunks/chunk-MED3XR5R.js";
import {
  slash
} from "../_node-chunks/chunk-UPJA2GEG.js";
import "../_node-chunks/chunk-3KEL2DNH.js";
import {
  Tag
} from "../_node-chunks/chunk-ZM5OBBY4.js";
import {
  require_dist
} from "../_node-chunks/chunk-VS2ESXA5.js";
import {
  require_lib,
  require_src
} from "../_node-chunks/chunk-BWWKZDLJ.js";
import {
  require_picocolors
} from "../_node-chunks/chunk-2WQFZWHB.js";
import {
  __commonJS,
  __require,
  __toESM
} from "../_node-chunks/chunk-P6DQJXPT.js";
...
async function getManagerBuilder() {
  return await import("../_node-chunks/builder-manager-PUKG5RQP.js");
}
  ...
  async function onChangeOrRemove(absolutePath, removed) {
    ...
    !removed && isDirectory(absolutePath) && await Promise.all(
      specifiers.filter((specifier) => importPath.startsWith(specifier.directory)).map(async (specifier) => {
        ...
        ), { globby } = await import("../_node-chunks/globby-CDGAT4WZ.js");
...
var getAttr = (elt, what) => elt.attributes.find((n) => n.type === "JSXAttribute" && n.name.name === what), getAttrValue = (elt, what) => getAttr(elt, what)?.value, getAttrLiteral = (elt, what) => {
  ...
  let store = {
    ...
    metaTags: void 0,
    imports: void 0
  }, { compile } = await import("../_node-chunks/mdx-N42X6CFJ-7B4JT7NT.js");
  await compile(code, {
...
var makeAbsolute = (otherImport, normalizedPath, workingDir) => otherImport.startsWith(".") ? slash(resolve3(workingDir, normalizeStoryPath(join5(dirname2(normalizedPath), otherImport)))) : otherImport, StoryIndexGenerator = class _StoryIndexGenerator {
  ...
  static async findMatchingFiles(specifier, workingDir, ignoreWarnings = !1) {
    ...
    if (cached)
      return cached;
    let pathToSubIndex = {}, globCwd = slash(resolve3(workingDir, specifier.directory)), globPattern = specifier.files.startsWith("!") ? `./${specifier.files}` : specifier.files, { globby } = await import("../_node-chunks/globby-CDGAT4WZ.js"), files = await globby(globPattern, {
      absolute: !0,
      cwd: globCwd,
